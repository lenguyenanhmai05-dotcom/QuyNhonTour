...
<body>
  ...
  <main class="poster">
    ...
    <div class="price-item adult">
      <h4>👨‍👩‍👧 Adult Price</h4>
      <p><strong>2.000.000 VND / person</strong></p>
    </div>
    <div class="price-item child">
      <h4>🧒 Child Price</h4>
      <p><strong>1.480.000 VND / child (free for children under 2 years old)</strong></p>
    </div>
  </div>
...
<script>
  function initMap() {
    // 🏖️ Vị trí Khu du lịch Trung Lương - Quy Nhơn
    const trungLuong = { lat: 13.9235, lng: 109.2877 };
