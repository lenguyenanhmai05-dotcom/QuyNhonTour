...
<br>- Shooting angle: from below to clearly see the curved roof, or from afar to capture both towers.
    ...
    <div class="price-item child">
      <h4>🧒 Child Price</h4>
      <p><strong>570.000 VND / child (free for children under 2 years old)</strong></p>
    </div>
  </div>

  <form action="booking.jsp" method="get">
    <input type="hidden" name="tourName" value="Eo Gio Tour"/>
    <input type="hidden" name="tourImage" value="images/eogio.jpg"/>
    <input type="hidden" name="adultPrice" value="770000"/>
    <input type="hidden" name="childPrice" value="570000"/>
...
<section class="map-section">
  <h2>📍 Tour Location — Eo Gio, Quy Nhơn</h2>
  <div id="map"></div>
</section>
