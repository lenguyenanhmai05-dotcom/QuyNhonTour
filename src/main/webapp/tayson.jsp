...
<br>- Return guests to the center – end of the exciting journey.
  ...
  <p>
    ...
    <div class="price-item adult">
      <h4>👨‍👩‍👧 Adult Price</h4>
      <p><strong>950.000 VND / person</strong></p>
    </div>
    <div class="price-item child">
      <h4>🧒 Child Price</h4>
      <p><strong>750.000 VND / child (free for children under 2 years old)</strong></p>
    </div>
  </div>

  <form action="booking.jsp" method="get">
    <input type="hidden" name="tourName" value="Tay Son Tour"/>
    <input type="hidden" name="tourImage" value="images/tayson.jpg"/>
    <input type="hidden" name="adultPrice" value="950000"/>
    <input type="hidden" name="childPrice" value="750000"/>
