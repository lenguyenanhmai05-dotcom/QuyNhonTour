    ...
    <div class="table-container">
        <table>
            ...
            <tr>
                ...
                <td>10/10/2025</td>
                <td>
                    <a href="user-edit.jsp?id=1" style="background:#f1c40f;color:black;padding:6px 10px;border-radius:4px;">Sửa</a>
                    <button style="background:#e74c3c;color:white;border:none;padding:6px 10px;border-radius:4px;">Xóa</button>
                </td>
            </tr>
            </tbody>
        </table>
