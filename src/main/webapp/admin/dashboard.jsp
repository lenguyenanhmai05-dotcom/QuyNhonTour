...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        body { font-family: 'Poppins', sans-serif; background: #f3f4f7; margin: 0; }
        header {
        ...
        header a { background:#f44336; color:white; padding:8px 16px; border-radius:20px; text-decoration:none; }
        .container { max-width:1200px; margin:36px auto; padding:0 20px; }
        h2 { text-align:center; color:#333; margin:0 0 28px; font-weight:600; }
...
@media (max-width: 480px) {
    .cards {
        ...
        .card {
            background:white; padding:22px; border-radius:12px; box-shadow:0 6px 18px rgba(0,0,0,0.06);
        ...
        .card .icon { font-size:36px; color:#2196f3; margin-bottom:10px; }
        .card h3 { margin:6px 0 8px; color:#333; font-size:16px; }
        .card .count { font-size:28px; font-weight:700; color:#111; }

        .chart-box { margin-top:36px; background:white; padding:22px; border-radius:12px; box-shadow:0 6px 18px rgba(0,0,0,0.06); }
        .manage-links {
    margin-top: 28px;
    text-align: center;
    display: flex;
...
.manage-links a:active {
    ...
    box-shadow: 0 3px 8px rgba(29, 78, 216, 0.3);
        ...
        @media (max-width:600px){ header { padding:12px; } .container{margin:16px auto;} }
    </style>
</head>
<body>
