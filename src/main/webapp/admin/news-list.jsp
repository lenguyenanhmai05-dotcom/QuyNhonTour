                    ...
                    <body>
                        ...
                        <div class="main">
                            ...
                            <div>
                                ...
                                <a href="<%= request.getContextPath() %>/admin/news?action=new" class="add-btn">+ Add
                                    New News</a>
                            </div>
                                        ...
                                        <% if (newsList !=null && !newsList.isEmpty()) { %>
                                            <% for (News n : newsList) { %>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="<%= request.getContextPath() + " /" + (n.getImageUrl()
                                                            !=null ? n.getImageUrl() : "images/default.jpg" ) %>"
                                                        width="100" height="60"
