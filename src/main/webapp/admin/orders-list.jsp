    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td><%= o.getObjectId("_id") %></td>
                    <td><%= o.getString("userEmail") %></td>
                    <td><%= o.getString("tourName") %></td>
                    <td><%= o.getString("status") %></td>
                    <td><%= o.getDouble("total") != null ? String.format("%,.0f₫", o.getDouble("total")) : "-" %></td>
                    <td><%= o.getString("createdAt") %></td>
                </tr>
                <%
                        }
                    } else {
