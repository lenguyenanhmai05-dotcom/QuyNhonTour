...
<br>- 12:00: End of tour - goodbye and see you again!
  ...
  <div class="price-box">
    <div class="price-item adult">
      <h4>👨‍👩‍👧 Adult Price</h4>
      <p><strong>3.800.000 VND / person</strong></p>
    </div>
    <div class="price-item child">
      <h4>🧒 Child Price</h4>
      <p><strong>3.300.000 VND / child (free for children under 2 years old) </strong></p>
    </div>
  </div>

  <form action="booking.jsp" method="get">
    <input type="hidden" name="tourName" value="Tay Son - Quy Nhon Tour"/>
    <input type="hidden" name="tourImage" value="images/taysonquynhon.jpg"/>
    <input type="hidden" name="adultPrice" value="3800000"/>
    <input type="hidden" name="childPrice" value="3300000"/>
...
<section class="map-section">
  <h2>📍 Tour Location — Tay Son, Quy Nhon</h2>
  <div id="map"></div>
</section>
  ...
  <script>
    function initMap() {
      ...
      new google.maps.Marker({
        ...
        map: map,
        title: "Bao Tang Quang Trung, Tay Son",
      });
    }
  </script>
